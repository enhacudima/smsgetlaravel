...
<div class="container" style="width: 400px;">
    ...
    <label>Bulck Messagen SMS Form</label>
    <hr>
<form action="{{ url('/savemessagen') }}" method="post">
            {{ csrf_field() }}
    <label for="fname">Title</label>

    <input type="text" id="title" name="title" placeholder="Mensagen title.." value="{{ old('title') }}">

    <label for="subject">Subject</label>
    <textarea id="subject" name="subject" placeholder="Write something.." value="{{ old('subject') }}"style="height:200px;height: 100px;"></textarea>
