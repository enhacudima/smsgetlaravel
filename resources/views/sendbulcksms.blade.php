...
<div class="container" >
    ...
    <hr>
<form action="{{ url('/sendsmsfinal') }}" method="post">
            {{ csrf_field() }}
    <label for="fname">Title</label>

    <select  type="text" id="title" name="title" placeholder="Mensagen title.." value="{{ old('title') }}">
        <option></option>
            @if(isset($messege))
            @foreach($messege as $cli) 
...
<div class="container2"style="width: 400px; margin-left: 20px">
<table class="table table-sm">
  <thead>
    <tr>
      <th scope="col">#</th>
